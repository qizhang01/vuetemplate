...
<div>
    <div>
        <article>
            <i class="primay-color my-icon-success"></i>
    ...
    <div class="PDPAddToBagSectionUI marginTop">
        <div class="PDPAddToBagSectionUI__addtoCartRow">
            ...
            <div class="FavoriteButtonUI__img-heart-wrapper btnFavorite" data-xc="favorite-button">
                <span class="FavoriteButtonUI__img-heart-wrapper__img-heart">
