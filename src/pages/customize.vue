<template>
    <div >
        <div class="customize-button__group">
            <IkeaButton>Popular</IkeaButton>
            <IkeaButton>All</IkeaButton>
            <IkeaButton>Velvets</IkeaButton>
            <IkeaButton>Pet-friendly</IkeaButton>
            <IkeaButton>Safeguard</IkeaButton>
        </div>
        ...
        <div class="customize-picture__wall">
            <IkeaPictureThumb v-for="item in selectBgPicture" :type="item.type" :imgUrl="item.imgUrl" :text="item.text" :bground="item.bground" :ifActive ="item.ifActive" :key="item.id" />
